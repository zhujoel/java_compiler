...
public class modulo {
	...
	/* script pour le test de modulo.deca */
    public static AbstractProgram ProgInit() {
        ...
        AbstractExpr expr1 = new FloatLiteral((float) 8.7);
        AbstractExpr expr2 = new IntLiteral(7);
        linst.add(new Assign(varName, new Modulo(expr1, expr2)));
    ...
    public static void genSyntaxTreeParserFile(String[] sourceName) throws IOException {
        ...
        if (prog == null) {
        	...
        	PrintStream ps = new PrintStream(new FileOutputStream(currentUsersDir + "/obtained/modulo.txt" , true));
            prog.prettyPrint(ps);
            ps.close();
        }
    }
    ...
    public static void genSyntaxTreeManualFile(AbstractProgram source) throws IOException {        
        PrintStream ps = new PrintStream(new FileOutputStream(currentUsersDir + "/expected/modulo.txt", true));
    ...
    public static void main(String args[]) throws IOException {
    	...
    	String path = currentUsersDir.substring(0, userspathlength - 41) + "/deca/syntax/valid/created/modulo.deca";
